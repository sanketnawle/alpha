...
//                    };
                    ...
                    function show_group(group_json){
                        ...
                        var check_wrap = '<div class = "event_post_option"><input type="checkbox" id = "event_{{name}}_input" name = "event_{{name}}_input" class="flat7cal checkbox_share_event"/><label for = "event_{{name}}_input" class = "flat7bcal"><span class = "move"></span></label><span class = "share_in_feed_text" style = "background-color:{{color.hex}}">Share in feed?</span></div>'
