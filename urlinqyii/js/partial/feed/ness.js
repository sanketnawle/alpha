...
$(document).ready(function () {
        ...
        var false_percent = $("#false_percent").attr('value');
        var true_percent = $("#true_percent").attr('value');
        
        console.log(false_percent);
        console.log(true_percent);
        $("#true_radio").on('click', function() {
            $("#false").css("background-color", "#666666");
            $("#true").css("background-color", "#222222");
            var temp_true_percent =  parseInt(true_percent) + 2; 
            /*will use this code after give the number of people who answers the questions
            var num_people_true = ((true_percent/100) * total_people; 
            var num_people_false = total_people - num_people_true;
            var new_total = total_people +1;
            var new_true_per = (num_people_true+1/new_total)*100;
            var new_true_per = (num_people_false/new_total)*100;
            */
            var temp_false_percent =  parseInt(false_percent) -2;
            $(this).parent('.true_choice').siblings('.false_choice').children("#false_percent").text(temp_false_percent + "%");
            $(this).siblings("#true_percent").text(temp_true_percent + "%");

        });
        $("#false_radio").on('click', function(){
            $("#true").css("background-color", "#666666");
            $("#false").css("background-color", "#222222");
            var temp_true_percent =  parseInt(true_percent) - 2; 
            /*will use this code after give the number of people who answers the questions
            var num_people_true = ((true_percent/100) * total_people; 
            var num_people_false = total_people - num_people_true;
            ...
            */
            var temp_false_percent =  parseInt(false_percent) + 2;
            $(this).siblings("#false_percent").text(temp_false_percent + "%");
            $(this).parent('.false_choice').siblings('.true_choice').children("#true_percent").text(temp_true_percent + "%");
