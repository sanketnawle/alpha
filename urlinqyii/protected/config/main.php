...
//		),
        'urlManager'=>array(
            ...
            'rules'=>array(
                ...
                '<action:(fileUpload|contact|login|test|json|home|register|logout|timezone|onboard|sendVerificationEmail|verify|finishOnboarding|resendVerificationEmail|sendVerificationEmailFunction|sendReset|reset)>'=>'site/<action>',
