...
<!--#endif-->
    ...
    <script type="text/javascript"> "<?= $tg=isset($_GET['pdf_target']) ? $_GET['pdf_target'] : ''; $erflag=isset($_GET['side_flag']) ? $_GET['side_flag'] : '0';?>"; var DEFAULT_URL = "<?= '../../../../../assets/pdfrepo/'.$tg ?>"; var event_return_flag = "<?= $erflag ?>";</script>
...
<!--#endif-->
  ...
  <body tabindex="1">
    <div class="EVT_SEED_REPO" style="display:none;"></div>
