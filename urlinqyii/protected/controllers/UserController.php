...
//        }
    ...
    public function get_notifications_data($user, $notifications){
    ...
    //            return;
                ...
                if ($notifications) {
                    ...
                    if (isset($_GET['mark_seen'])) {
                        ...
                        $data = array('success'=>true,'notifications'=>$this->get_notifications_data($user, $notis_to_return));
                        $this->renderJSON($data);
                        return;
