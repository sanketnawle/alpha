...
<!--        <script>alert('--><?php //echo Yii::app()->getBaseUrl(true); ?><!--');</script>-->
        <script src="<?php echo Yii::app()->getBaseUrl(true); ?>/LKJSDOKLSJD/calendar_selector.js" type="text/javascript"></script>
					...
					<div class="entry_field">
						...
						<div class="planner_creation_form">
							...
							<div class="event_action">
								...
								<input type="submit" class="create_form" id="create_form" name="create_form" value="Add this To-Do">
							</div>
						</div>
					</div>
