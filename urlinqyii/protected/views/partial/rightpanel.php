...
<head>
    ...
    <link href="<?php echo Yii::app()->getBaseUrl(true); ?>/css/partial/rightpanel/rightpanel.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<script>
    (function($){
        $(function () {
            $(".rightpanel .scrollable .title").click(function () {
                var title = $(this);
                var clubs = $(".rightpanel .scrollable.club");
                var classes = $(".rightpanel .scrollable.class");
            ...
            $(".rightpanel .profile .title").click(function () {
                var menu = $(".menu", $(this));
            ...
            $(".rightpanel .scrollable ul").mCustomScrollbar({
                theme: "minimal-dark",
                scrollInertia: 100
            });
        })
