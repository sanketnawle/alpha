						...
						<tbody style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
							<tr style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
								...
								<td align="right" class="urlinq_tri_color" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;width: 33%;right: 10px;height: 5px;top: 35px;position: relative;">
									<img class="logo tricolor_float_logo" style="background-repeat: no-repeat;background-size: contain;margin: 0;padding: 15px;font-family: 'Open Sans', sans-serif;max-width: 100%;width: 114px;left: 50%;position: absolute;height: 26px;right: 0px;margin-top: 8px;margin-left: -57px;" src="http://beta.urlinq.com/assets/email_logo.png">										
								</td>
				...
				<tbody style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;"><tr style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
					<td align="center" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
						<p class="footer_Text" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;margin-bottom: 10px;font-weight: normal;font-size: 14px;line-height: 1.6;">
							...
							<a href="<?php echo Yii::app()->getBaseUrl(true); ?>/unsubscribe?email=<?php echo $to_user->user_email; ?>" style="text-decoration:none; margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;color: #fff;"><unsubscribe style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">Unsubscribe</unsubscribe></a>
						</p>
					</td>
				</tr>
			</tbody></table>
