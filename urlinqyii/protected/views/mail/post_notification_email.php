						...
						<tbody style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
							<tr style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
								...
								<td align="right" class="urlinq_tri_color" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;width: 33%;right: 10px;height: 5px;top: 35px;position: relative;">
									<img class="logo tricolor_float_logo" style="background-repeat: no-repeat;background-size: contain;margin: 0;padding: 15px;font-family: 'Open Sans', sans-serif;max-width: 100%;width: 114px;left: 50%;position: absolute;height: 26px;right: 0px;;margin-left: -57px;margin-top:8px;" src="http://beta.urlinq.com/assets/email_logo.png">										
								</td>
					...
					<td style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;">
						...
						<p class="post_callout" style="margin: 0;padding: 0px;font-family: 'Open Sans', sans-serif;margin-bottom: 15px;font-weight: 400;font-size: 18px;line-height: 1.6;background-color: #FFF;text-align: left;border-bottom: 1px solid #777;margin-left: 40px;padding-bottom: 6px;margin-right: 40px;">
                            ...
                            <?php if($post->origin_type == 'class'){ ?>
							    <span class="post_details" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;color: #575757;"><?php echo ucfirst($post_type); ?> in <a href="<?php echo Yii::app()->getBaseUrl(true) . '/' . $post->origin_type . '/' . $post->origin_id; ?>" class="section_course_name" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;color: #029acf;text-decoration: none;"><?php $course_tag = $origin->course->course_tag; if($course_tag && $course_tag != ''){ echo $course_tag . ', '; } echo $origin_name; ?></a></span>
						    <?php }else if($post->origin_type == 'club' || $post->origin_type == 'group'){ ?>
    							    <span class="post_details" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;color: #575757;"><?php echo ucfirst($post_type); ?> in <a href="<?php echo Yii::app()->getBaseUrl(true) . '/' . $post->origin_type . '/' . $post->origin_id; ?>" class="section_course_name" style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;color: #029acf;text-decoration: none;"><?php echo $origin_name; ?></a></span>
