    ...
    <div class="profile-content">
        ...
        <div class="user-info-wrapper">
            ...
            <div class="user-info">
                <h1>
                    <a href="#">
                        <span class="info_username" id="profile_name"><?php $userProfile->firstname.' '.$userProfile->lastname;?></span>
                    </a>
                </h1>
                <p class="school-info">2015 | <?php echo $university->university_name; ?> | Senior</p>
            </div>
            <!--<h5>ABOUT</h5>
            <span class="profile-bio-container" id="profile_about">
            ...
            <div class="info-block" id="about_textarea">
                <textarea maxlength="140" readonly><?php $userProfile->user_bio;?></textarea>
            </div>
            <h3>INTERESTS AND SKILLS</h3>
            <div class="info-block">
                <input name="interest_name" value="Spanish" readonly>
            </div>
            <h5 class="secondh5">Interests</h5>
                    <span class="profile-ints-container" id="profile_interests">
