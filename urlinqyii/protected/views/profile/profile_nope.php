            ...
            <div class="profile-content">
                <div class="user-info-wrapper">
					...
					<div class="user-information">
						...
						<!--<div class="info-block" id="username-entry-field">
					...
					<h3 id="major-section">MAJOR</h3><i></i>
					<div class="info-block">
						<input name="major_name" value="Computer Science" readonly><i></i>
					</div>
					<h3 id="minor-section">MINOR</h3><i></i>
					<div class="info-block">
						<input name="minor_name" value="Spanish" readonly><i></i>
					</div>
