...
$(".university").css({"background-position":"50% 100%","background-size":"27px","opacity":"1"});
...
$(".university").css({"background-position":"50% 50%","background-size":"27px","opacity":"1"}); 
...
$(".university").css({"background-position":"top","background-size":"27px","opacity":"1"}); 
}
});            
