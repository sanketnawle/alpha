...
if(isset($_POST['messageid']) && $_POST['messageid']!='')
{
	...
	$sql_insert="INSERT INTO `university_reply_1` (`messageid`, `studentid`, `profid`, `replymessage`,`update_timestamp`)VALUES( '".$messageid."', '".$studentid."', '".$profid."', '".$comment."','".$update_timestamp."')";
