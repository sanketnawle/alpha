...
$(".university").css({"background-position":"50% 100%","background-size":"32.5px","opacity":"1","top":"9px"});
 if ( jQuery.browser.mozilla ) {
$(".university").css({"background-position":"50% 101%","background-size":"32.5px","opacity":"1","top":"8px"});
}
...
$(".university").css({"background-position":"50% 50%","background-size":"32.5px","opacity":"1","top":"9px"}); 
 if ( jQuery.browser.mozilla ) {
$(".university").css({"background-position":"50% 51%","background-size":"32.5px","opacity":"1","top":"8px"});
}                           
...
$(".university").css({"background-position":"top","background-size":"32.5px","opacity":"1","top":"8px"}); 
if ( jQuery.browser.mozilla ) {
