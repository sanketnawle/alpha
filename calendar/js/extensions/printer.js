...
ulcal.service("PrinterService", function ($timeout) {
    this.print = function (node) {
        ...
        mywindow.document.write('<link href="font/avenir.css" rel="stylesheet" type="text/css">');
        mywindow.document.write('<link rel="stylesheet" href="css/master.css" type="text/css" />');
        mywindow.document.write('<link rel="stylesheet" href="css/week.css" type="text/css" />');
        mywindow.document.write('<link rel="stylesheet" href="css/month.css" type="text/css" />');
        mywindow.document.write('<link rel="stylesheet" href="css/header.css" type="text/css" />');
