...
<?php
	...
	if(isset($user_id)){
		if(!is_null($user_id) AND !trim($user_id)==""){
			$p_query = $con->prepare("SELECT user_email, user_type, firstname, lastname, univ_id, dept_id, user_bio, profile_picture, status FROM user WHERE user_id = ?");
			
			if($p_query){
				$p_query->bind_param('i',$user_id);
				if($p_query->execute()){
					$p_query->bind_result($user_email, $user_type, $firstname, $lastname, $univ_id, $dept_id, $user_bio, $profile_picture, $status);
					$p_query->fetch();
					$p_query->close();
				}
			...
			<div class = 'main-2'>
				<div class = 'prof-header-bar-alias'>
					...
					<div class = 'personal-website-wrap' style='left:510px;' id='edit_grad_year' style='display:none;'>
						...
						<div class = 'website-inp-wrap'>
							<input type = 'text' id = 'stu_type' name = 'graduation_type' class = 'user_website user_inp_full' placeholder = 'Graduation Level'>
						</div>
						<div class = 'website-inp-wrap'>
				...
				<div class = 'profile-content-2'>
					<div class = 'user-info-wrapper-2'>
						...
						<div class = 'user-info-editable interest-editable'>
							<textarea id = 'user_interest' name = 'user_interest' class = 'user_interest user_inp_big' placeholder = 'Introduce your Interests' maxlength = '100'></textarea>
					...
					<div class = 'resource-wrapper resources-vacant'>						
						...
						<div class='clickable_showcase_step2 showcase_step2' style='display:none;'>
							...
							<div class='step2_content_anchor step2_content_anchor_files' style='display:none;'>
									<textarea id='titlefileupload' class="uploaddes_sc dotline_txtbox" placeholder="Title for the Showcase"></textarea>
                					<div>
							...
							<div class='step2_content_anchor step2_content_anchor_link' style='display:none;'>
								<textarea id='titlelinkupload' class="uploaddes_sc dotline_txtbox" placeholder="Title for the Showcase"></textarea>
					...
					<div class = 'profile-options has-dropdown'>
						...
						<a class = 'user-website'>
							...
							<span class = 'office-hours' id='studentGradYear' style='display:none;'>
								...
								<b style='margin-left: -158px; margin-top: 12px;'>Graduating on</b><b id='graduatingOn'></b>								
							</span>
