...
switch ($type) {
    case $personal_invited_event:
        $set_personal_event_seen_query = "UPDATE personal_event_invited SET `show_notification` = 0 WHERE `user_id` = $user_id
        ...
        break;
    case $course_event:
        $set_course_event_seen_query = "UPDATE course_event_invited SET `show_notification` = 0 WHERE `user_id` = $user_id
            AND `event_id` = $event_id";
        ...
        break;
    case $group_event:
        $set_group_event_seen_query = "UPDATE group_event_invited SET `show_notification` = 0 WHERE `user_id` = $user_id
            AND `event_id` = $event_id";
