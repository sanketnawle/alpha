                ...
                $('#calendar').fullCalendar('renderEvent',
                 {
                     ...
                     end: responseText.events_array[i]["start_date"],//responseText.events_array[i]["end_date"],
                     allDay: true,
...
$(document).ready(function () {
    ...
    $('#btnAddThisEvent').click(function () {
        ...
        $.ajax({
            ...
            data: {
                title: title, location: locn, details: desc, start_date: start, end_date: end, start_time: fromtime, end_time: totime, repeat: repeat
                , connections: allVals, file_location: "", file_name: ""
            },
            type: "POST",
            dataType: "text",
            success: function (responseText) {
    ...
    $.ajax({
        ...
        success: function (responseText) {
            if ($(".timeline").children("li").length == 1) {
                ...
                for (var i = 0; i < responseText.events_array.length; i++) {
                    ...
                    if (responseText.events_array[i]['type'] == "1") {
                        appendString += DisplayToDo(responseText.events_array[i], formattedTime);
                    }
                    else if ((responseText.events_array[i]['type'] == "2") || (responseText.events_array[i]['type'] == "3")){
                        appendString += DisplayPersonalInvited(responseText.events_array[i], formattedTime);
                    }
                    else if ((responseText.events_array[i]['type'] == "4") || (responseText.events_array[i]['type'] == "5") || (responseText.events_array[i]['type'] == "6")){
                        appendString += GroupPersonal(responseText.events_array[i], formattedTime);
                    }
                    //else if (responseText.events_array[i]['type'] == "5") {
                    //    appendString += Group(responseText.events_array[i], formattedTime);
                    //}
                    //else if (responseText.events_array[i]['type'] == "6") {
                    //    appendString += CoursePersonal(responseText.events_array[i], formattedTime);
                    //}
                    else if (responseText.events_array[i]['type'] == "7") {                                                                   
                        if (prevEventDate != (new Date(responseText.events_array[i]['start_date'])).toDateString().substr(0, 10)) {
                            prevEventDate = (new Date(responseText.events_array[i]['start_date'])).toDateString().substr(0, 10);
                            appendString += '<li><div class="event_day_time">' + prevEventDate + '</div>'
                        }
                        else {
                            appendString += '<li style="position:relative; top:-35px;padding:0px;"><div class="event_day_time fade-out">' + prevEventDate + '</div>'
                        }
            ...
            + '<div class="direction-r">'
                + '<div class="desc">'
                    + '<div class="event_main_header">'
                        ...
                        if ((responseText.events_array[i]['title'] != null)) {
                            appendString += responseText.events_array[i]['title'];
                        }
                        appendString += '</div>';
                        if ((responseText.events_array[i]['type'] != "1")) {
                  ...
                  + '<div class="right_data">'
                      ...
                      + '<div class="event-data">';
                        if ((responseText.events_array[i]['location'] != null)) {
                            appendString += responseText.events_array[i]['location'];
                        }
                        appendString += '</div>';
        ...
        + '<div class="info_wrapper bottom_right_data">'
            + '<div class="event_info">';
                        if ((responseText.events_array[i]['description'] != null)) {
                            appendString += responseText.events_array[i]['description'].toString().substr(0, 220);
                        }
              ...
              + '<div id="description" class="more">';
                        if ((responseText.events_array[i]['description'] != null)) {
                            appendString += responseText.events_array[i]['description'].toString().substr(221, responseText.events_array[i]['description'].toString().length)
                        }
            ...
            + '<div class="creator_wrapper">'
                + '<a class="event_creator">'
                    ...
                    + '<div class="creator_name">'
                        + responseText.events_array[i]['name'].toString()                                                                  
                    + '</div>'
...
function DisplayToDo(ary, formattedTime) {
    var appendVal = "";    
    if (prevEventDate != (new Date(ary['start_date'])).toDateString().substr(0, 10)) {
        prevEventDate = (new Date(ary['start_date'])).toDateString().substr(0, 10);
        appendVal += '<li><div class="event_day_time">' + prevEventDate + '</div>'
    }
    else {
        appendVal += '<li style="position:relative; top:-35px;padding:0px;"><div class="event_day_time fade-out">' + prevEventDate + '</div>'
    }
...
/*
function DisplayPersonal(ary, formattedTime) {
    var appendVal = "";
    appendVal += '<li>';
    if (prevEventDate != (new Date(ary['start_date'])).toDateString().substr(0, 10)) {
        prevEventDate = (new Date(ary['start_date'])).toDateString().substr(0, 10);
        appendVal += '<div class="event_day_time">' + prevEventDate + '</div>'
    }
    else {
        appendVal += '<div class="event_day_time fade-out hide">' + prevEventDate + '</div>'
    }
    appendVal += '<div class="flag-wrapper direction-r">'
                                                + '<span class="flag1"></span>'
                                                + '<span class="arrow_box">'
            ...
            + '<div class="direction-r">'
                + '<div class="desc">'
                    + '<div class="event_main_header" style="width:100%;">'
                        + '<div class="event-content">'
                            //+ '<div class="event_right">'
                                + '<div class="header_wrapper">'
                                    + '<div class="event-header-left">'
...
function DisplayPersonalInvited(ary, formattedTime) {
    ...
    if (prevEventDate != (new Date(ary['start_date'])).toDateString().substr(0, 10)) {
        ...
        appendVal += '<li style="position:relative; top:-35px;padding:0px;"><div class="event_day_time fade-out hide">' + prevEventDate + '</div>'
    }
    appendVal += '<div class="flag-wrapper direction-r">'
                                                   + '<span class="flag1"></span>'
                                                   + '<span class="arrow_box">'
...
function GroupPersonal(ary, formattedTime)
{
    ...
    updateVal += '<li>'
                                            ...
                                            + (new Date(ary['start_date'])).toDateString().substr(0, 10)
                                            + '</div>'
...
+ '<div class="right_data">'
  ...
  + '<div class="event-data">';
    if ((ary['location'] != null)) {
        updateVal += '<div class="info_wrapper" style="border-bottom: 1px solid #E9EAED;width:100%;">'
            + '<div class="right_data" style="border-right:none;">'
                + '<img class="event_icons" src="img/location_icon.png">'
                + '<div class="event-data">'
                + ary['location']
    ...
    updateVal += '<div class="event_left">'
+ '</div>'
+ '</div>';
    if ((ary['description'] != null)) {
        updateVal += '<div class="info_wrapper bottom_right_data" style="border-top:none;">'
                + '<div class="event_info">';
        if (ary['description'].toString().length <= 220) {
