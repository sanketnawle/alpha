<div class="planner">
  ...
  <div class="add_upcoming">
    <form>
      <textarea placeholder="+ Add new Event" class="pl_add" id="pl_add"></textarea>
      <div class="pl_addevnt">
        ...
        <div class="evnt_inps">
          <input id="set_date" class="set_date" />
          <input type="text" id="set_time_24hr" placeholder="Add a time?" class="set_time" />
          <div id="calLayer" class="calLayer">
