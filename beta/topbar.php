...
<body>
		...
		<div class = "topbar">
			<div class = "topbar_wrapper">
				<img class = "lftbar_ctr flip" src = "img/burger_closed.png">
				...
				<div class='topbar_search'>
					<div class = "topbar_search_container">
							...
							<div class = "search_main_div">
								<form name = "search" method = "get">
									<div class = "search_input_wrapper">
										...
										<div class='topbar_qicon'><img src='img/question.png'>
										<div class = "card-tag">
						...
						<div class='graph_search'>
							...
							<div class='gs_col'><img class='gs_icon' src='img/avatar2.png'><div>Find your professor</div>
							</div> 
							...
							<div class='gs_col last_gscol'><img class='gs_icon' src='img/avatar2.png'><div>Find your professor</div>
							</div> 
