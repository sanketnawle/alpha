...
while ($row = $get_course_details_query_result->fetch_array()) {
    ...
    <div class = "group-head-sec">
        ...
        <div class = "group-pic-frame">
             <div class = "group-pic" style="background-image:url(' . get_dp($con, $class_id, "class") . '); . background-size:cover;">
            </div>';
    if ($admin_flag > 0) {
        echo '
            <form>
    ...
    ' . $course_location . '
            ...
            <div class = "ghr-3 ghr-box" >
                <a class = "department-link" href="department.php?dept_id=' . $dept_id . '">
                    <div class = "ghr-box-head" >
                        <div class = "ghr-icon-3 ghr-icon" style="background-image:url(' . get_dp($con, $dept_id, "dept") . ');background-size:cover;height:20px;width:20px;display: inline-block;border-radius:4px;" >
                        </div >
        ...
        <div class = "group-head-footer" >
            <div class = "group-header-tab" >
				...
				if (is_member_of($con, $_SESSION['user_id'], 'class', $_GET['class_id'])) {
    ...
    SYLLABUS
     ...
     echo '</div ><div class = "group-footer-functions" >';
    if ($admin_flag > 0) {
        echo '
            </div >
        </div >
