$(document).ready(function(){
	...
	var jsonData = [{"post_id":"463","user_id":"350","target_type":null,"target_id":null,"target_univ_id":"1","post_type":"question",
	 ...
	 {'anon' : 0, 'the_c
	 hoice_letter' : 'D', 'the_choice_text' : 'This is choice d', 'percent_selected' : 25, 'people_who_answered_len' : 3, 'people_who_answered' : [{name:"Alex Lopez"}, {name:"Alex Lopez"}, {name:"Alex Lopez"}]}],
