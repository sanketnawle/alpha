...
while ($row = mysqli_fetch_array($get_classes_query_result)) {
    ...
    echo "
            <div class = 'item courses-selector' id='" . $this_class_id . "'>
                <div class = 'courses ajax'>
                    <div class = 'course-top course-row'>
                        <div class = 'leftFloat'>
                            <div class = 'frame'>
                                <img width = '44px' height = '44px' src = '" . get_dp($con, $this_class_id, 'class') . "' class = 'coursePicture'>
                            </div>
                            ...
                            <div class = 'course-professor'>
                                 <span>Taught by</span>
                                <img  width = '21px' height = '21px' src = '" . get_dp($con, $row['professor'], 'user') . "' class = 'professorPicture'>";
    if ($row['professor'] == null or $row['professor'] == 'NULL') {
        echo "
                                <a class = 'courseCardLink'>TBA</a>
                            </div>
                        </div>";
    } else {
        echo "
                                <a href='profile.php?user_id=" . $row['professor'] . "' class = 'courseCardLink'>Professor " . $row['lastname'] . "</a>
                            </div>
                        </div>";
    }
    if ($user_type == 'p') {
