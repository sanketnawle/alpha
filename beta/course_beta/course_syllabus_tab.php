...
$get_admin_event_query = "SELECT CE.* FROM course_event CE
    WHERE (CE.user_id IN (SELECT user_id FROM courses_user WHERE class_id = '$class_id' AND is_admin = 1) OR CE.user_id IN (SELECT professor FROM courses_semester WHERE class_id = '$class_id'))";
...
echo "
    <div class = 'syllabus-tab-content'>
        <div class='syla-evt_ctr'>
            ...
            <input type='file' class='upload-syla-input'></input>
            <div class='blue_btn'>Download Syllabus</div>
            <div class='blue_btn'>Create Schedule</div>
        </div>
    ...
    foreach ($events_array as $event) {
        ...
        if ($prev_week_start_date == $week_start_timestamp->format("Y-m-d")) {
            ...
            if ($admin_flag > 0) {
                ...
                if ($event['choice'] == -1 or $event['choice'] == 0) {
                    echo "
                            <div class='a_weekview_right'>
                                <div class='syla_tag syla_tag_lec'>" . $event['event_class'] . " <span class='check_syla'></div>
                            </div>
...
//                <div class='weekview_content'>
//                    <div class='a_weekview'>
//                        <div class='a_weekview_left'>Wed, Jan 25</div>
//                        <div class='a_weekview_mid'>
//                            <div class='a_weekview_mid_head'><span class='a_weekview_mid_head_topic'>Course Introduction</span>
//                            <span class='a_weekview_mid_head_time'>6:20pm- 9:20pm</span>
//                            </div>
//                            <div class='a_weekview_mid_content'>
//                                Lecture Course Introduction, Course Policy etc. sdjfhjsfdghkj  kjfghkdfjg dfjghdfkg kjdfghkfj jfdghjkdg
//                            </div>
//
//                        </div>
//                        <div class='a_weekview_right'>
//                            <div class='syla_tag syla_tag_lec'>Lecture <span class='check_syla'></div>
//                        </div>
//                        <div class = 'help-div-black help-div' id ='help-2'>
//                            <div class ='help-wedge-black help-wedge2'></div>
//                            <div class = 'help-box-black help-box2'>
