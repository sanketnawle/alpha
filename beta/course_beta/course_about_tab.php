...
$get_course_about_query_result = mysqli_query($con, $get_course_about_query);
...
$course_about_row = mysqli_fetch_array($get_course_about_query_result);
...
$get_course_connection_query_result = mysqli_query($con, $get_course_connection_query);
...
if ($user_count > 0) {
    ...
    ";
    while ($row = mysqli_fetch_array($get_course_connection_query_result)) {
        echo "
                            <li class = 'people-box'>
                                <div class = 'person-pic-wrap' style='background-image:url(../includes/get_blob.php?img_id=" . $row['user_id'] . ")'>
                                </div>
...
WHERE class_id = '$class_id' AND is_admin = 0 LIMIT 0,8)";
    $get_course_student_query_result = mysqli_query($con, $get_student_query);
           ...
           <div class = 'about-tab-members about-tab-block'>
                ...
                <div class = 'tab-block-content tab-block-content-scroll'>
                    <div class = 'members-scrollwrap'>
                        <ul class = 'people-you-know'>
    ";
        while ($row = mysqli_fetch_array($get_course_student_query_result)) {
            echo "
                            <li class = 'people-box'>
                                <div class = 'person-pic-wrap' style='background-image:url(../includes/get_blob.php?img_id=" . $row['user_id'] . ")'>
                                </div>
...
JOIN file_upload FU on FU.file_id = CF.file_id
...
if (mysqli_num_rows($get_course_files_query_result) > 0) {
    ...
    ";
    $file_row = mysqli_fetch_array($get_course_files_query_result);
