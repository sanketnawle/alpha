...
<!--#endif-->
    ...
    <script type="text/javascript"> "<?= $tg=isset($_GET['pdf_target']) ? $_GET['pdf_target'] : ''; $erflag=isset($_GET['side_flag']) ? $_GET['side_flag'] : '0';?>"; var DEFAULT_URL = "<?= '../../pdfrepo/'.$tg ?>"; var event_return_flag = "<?= $erflag ?>";</script>
