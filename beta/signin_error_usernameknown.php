                ...
                <div class = "ui-box-content">
                  <div class = "ui-error-box login-error">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <a href="/beta/PasswordReset.php">Request a new one.</a>
                      </p>
                    </div>
                  </div>
                  <div class = "ui-form-wrap">
                        ...
                        <div class = "pic-wrap">
                          ...
                          <?php 
                              $email=$_SESSION['login_email'];
                                $query=mysqli_query($con,"SELECT user_id,firstname,lastname FROM user WHERE user_email='$email'");
                                if(!$query){
                    ...
                    <div class = "signin_err_box_moreoptions">
                      <div class = "leftFl">
                        <form class="forgotpassword" method="post" action="PasswordReset.php">
