...
if (is_null($cover_blob)) $c_link = "DefaultImages/club.png";
else $c_link = "includes/get_blob.php?img_id=" . $cover_blob;
echo '
                        <div class = "group-head-top-sec" style="background-size:cover; background:url(' . $c_link . ') no-repeat scroll 50% center / 100% auto #333;">
...
if (is_null($dp_blob)) $link = "DefaultImages/club.png";
else $link = "includes/get_blob.php?img_id=" . $dp_blob;
echo '<div class = "group-pic" style="margin-top: 5px; margin-left: 5px;
                                background-size:cover; background:url(' . $link . ') no-repeat scroll 50% center / 100% auto #F8F8F8;">
                            </div>';
if ($is_admin == "1") {
...
if (is_member_of($con, $_SESSION['user_id'], 'club', $_GET['group_id'])) {
                                    echo '<li class = "tab-no-badge group-tab" >
                                        <a class = "tabc tab-anchor tab-inactive" >
                                            <div class = "tab-title" style="margin-left:20px;">
                                                EVENTS
	...
	if ($univ_id == $_SESSION['univ_id']) {
		if (($is_member > 0)) {
			echo '<a class = "joined">
                                                                    ...
                                                                    <!--<div class = "help-div" id = "help-4" style="margin-left: 80%; margin-top: 35px;">
                                                                    <div class = "help-wedge">
                                                                    </div>
                                                                    <div class = "help-box">
