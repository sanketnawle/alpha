...

{
    ...
    } else if ((substr($file_type, -8) == "document") OR (substr($file_type, -6) == "msword") OR (substr($file_type, 0, 4) == "text")) {
    ...
    } else if ((substr($file_type, -14) == "zip-compressed") OR (substr($file_type, -3) == "zip")) {
