                                ...
                                <div id="bc3contentAddEvent">
                                    ...
                                    <div class="add_event_container">
                                        ...
                                        <div class="addevent-header0-1">
                                            ...
                                            <h1 class="addevent-header1-1">Add Event</h1>
                                ...
                                <section id="Section1" class="mounth" style="margin-left: 43px; margin-top: 20px;">
                                    ...
                                    <article>
                                        ...
                                        <div class="dates">
                                            ...
                                            <span id="calcell_su_43" class="calcell disable cl_0"></span>

                                            <span id="calcell_mo_44" class="calcell disable cl_1"></span>



                                            <span id="calcell_tu_45" class="calcell disable cl_2"></span>

                                            <span id="calcell_we_46" class="calcell disable cl_3"></span>

                                            <span id="calcell_th_47" class="calcell disable cl_4"></span>

                                            <span id="calcell_fr_48" class="calcell disable cl_5"></span>

                                            <span id="calcell_sa_49" class="calcell disable cl_6"></span>

                                            <span id="calcell_su_50" class="calcell disable cl_7"></span>

                                            <span id="calcell_mo_51" class="calcell disable cl_8"></span>

                                            <span id="calcell_tu_52" class="calcell disable cl_9"></span>

                                            <span id="calcell_we_53" class="calcell disable cl_10"></span>

                                            <span id="calcell_th_54" class="calcell disable cl_11"></span>

                                            <span id="calcell_fr_55" class="calcell disable cl_12"></span>

                                            <span id="calcell_sa_56" class="calcell disable cl_13"></span>

                                            <span id="calcell_su_57" class="calcell disable cl_14"></span>

                                            <span id="calcell_mo_58" class="calcell disable cl_15"></span>

                                            <span id="calcell_tu_59" class="calcell disable cl_16"></span>

                                            <span id="calcell_we_60" class="calcell disable cl_17"></span>

                                            <span id="calcell_th_61" class="calcell disable cl_18"></span>

                                            <span id="calcell_fr_62" class="calcell disable cl_19"></span>

                                            <span id="calcell_sa_63" class="calcell disable cl_20"></span>

                                            <span id="calcell_su_64" class="calcell disable cl_21"></span>

                                            <span id="calcell_mo_65" class="calcell disable cl_22"></span>

                                            <span id="calcell_tu_66" class="calcell disable cl_23"></span>

                                            <span id="calcell_we_67" class="calcell disable cl_24"></span>

                                            <span id="calcell_th_68" class="calcell disable cl_25"></span>

                                            <span id="calcell_fr_69" class="calcell disable cl_26"></span>

                                            <span id="calcell_sa_70" class="calcell disable cl_27"></span>

                                            <span id="calcell_su_71" class="calcell disable cl_28"></span>

                                            <span id="calcell_mo_72" class="calcell disable cl_29"></span>

                                            <span id="calcell_tu_73" class="calcell disable cl_30"></span>

                                            <span id="calcell_we_74" class="calcell disable cl_31"></span>

                                            <span id="calcell_th_75" class="calcell disable cl_32"></span>



                                            <span id="calcell_fr_76" class="disable calcell cl_33"></span>

                                            <span id="calcell_sa_77" class="disable calcell cl_34"></span>

                                            <span id="calcell_su_78" class="disable calcell cl_35"></span>

                                            <span id="calcell_mo_79" class="disable calcell cl_36"></span>

                                            <span id="calcell_tu_80" class="disable calcell cl_37"></span>

                                            <span id="calcell_we_81" class="disable calcell cl_38"></span>

                                            <span id="calcell_th_82" class="disable calcell cl_39"></span>

                                            <span id="calcell_fr_83" class="disable calcell cl_40"></span>

                                            <span id="calcell_sa_84" class="disable calcell cl_41"></span>
                                ...
                                <div class="event_main">
                                    ...
                                    <ul class="timeline">
                                        ...
                                        <li>
                                            ...
                                            <div class="event_day_time" style="opacity: 0; line-height: 0px;">
                                            ...
                                            <div class="direction-r">
                                                ...
                                                <div class="desc">
                                                    ...
                                                    <div class="event_main_header">
                                                            ...
                                                            <div class="event_right">
                                                                ...
                                                                <div class="info_wrapper">
                                                                    ...
                                                                    <div class="event_join">
                                                                        ...
                                                                        <!--<button class="btn-addevent-1 btn-addevent" id="Button7" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Accept</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button8" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Maybe</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button9" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Reject</button>-->
                                                        ...
                                                        <div class="info_wrapper bottom_right_data">
                                                            ...
                                                            et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
                                                                ...
                                                                <a href="#" id="A3" class="showLink"

                                                                    onclick="showHide(this);return false;">See more.</a>

                                                                <div id="Div2" class="more">
                                                    ...
                                                    <div class="event_qa" style="display: none;" id="div8">
                                        ...
                                        <li>
                                            ...
                                            <div class="direction-r">
                                                ...
                                                <div class="desc">
                                                    ...
                                                    <div class="event_main_header">
                                                            ...
                                                            <div class="event_right">
                                                                ...
                                                                <div class="info_wrapper">
                                                                    ...
                                                                    <div class="event_join">
                                                                        ...
                                                                        <!--<button class="btn-addevent-1 btn-addevent" id="Button4" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Accept</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button5" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Maybe</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button6" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Reject</button>-->
                                                        ...
                                                        <div class="info_wrapper bottom_right_data">
                                                            ...
                                                            et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
                                                                ...
                                                                <a href="#" id="A1" class="showLink"

                                                                    onclick="showHide(this);return false;">See more.</a>

                                                                <div id="Div1" class="more">
                                                    ...
                                                    <div class="event_qa" style="display: none;" id="div7">
                                        ...
                                        <li>
                                            ...
                                            <div class="flag-wrapper direction-r">
                                                ...
                                                <span class="arrow_box">
                                                    ...
                                                    <div class="left_data1">
                                                        ...
                                                        <img class="event_icons1" src="src/time_icon.png">
                                            ...
                                            <div class="direction-r">
                                                ...
                                                <div class="desc">
                                                    ...
                                                    <div class="event_main_header">
                                                            ...
                                                            <div class="event_right">
                                                                ...
                                                                <div class="info_wrapper">
                                                                    ...
                                                                    <div class="right_data">
                                                                        ...
                                                                        <img class="event_icons" src="src/location_icon.png">
                                                                    ...
                                                                    <div class="event_join">
                                                                        ...
                                                                        <!--<button class="btn-addevent-1 btn-addevent" id="Button10" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Accept</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button11" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Maybe</button>

                                                                        <button class="btn-addevent-1 btn-addevent" id="Button12" style="min-width: 0px; margin-right: 5px; font-size: 10px; height: 20px; line-height: 5px;">Reject</button>-->
                                                        ...
                                                        <div class="info_wrapper bottom_right_data">
                                                            ...
                                                            et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
                                                                ...
                                                                <a href="#" id="A5" class="showLink"

                                                                    onclick="showHide(this);return false;">See more.</a>

                                                                <div id="Div5" class="more">
                                                    ...
                                                    <div class="event_qa" style="display: none;" id="div6">

                                                        <div class="qa_header">

                                                            <div class="icon_text">

                                                                <img src="src/qa_icon.png" width="22" height="22">
