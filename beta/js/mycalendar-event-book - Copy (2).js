            ...
            $.ajax({
                ...
                data: //[dataString],
                    event_id == "" ?
                    {
                        ...
                        , end_time: totime , repeat:  repeat , connections:  allVals, month_date: monthdate  
                    } :
                    {
                        title: title, location: locn, details: desc, start_date: start, end_date: end, start_time: fromtime
                        , end_time: totime, repeat: repeat, connections: allVals, event_id: event_id, type: event_type, month_date: monthdate
                    },
                type: "POST",
                dataType: "json",
                success: function (responseText) {
