...
(function (t, e) {
    ...
    function a(n, r) {
        function a() {
            v = r.theme ? "ui" : "fc";
            //r.header["center"] = "month,agendaWeek,agendaDay";
            //r.header["left"] = "prev,title,next";
            //r.header["right"] = "prevYear,today,nextYear";
            var n = r.header;
        ...
        function i(e) {
            ...
            return o && t.each(o.split(" "), function (e) {
                ...
                t.each(this.split(","), function (e, i) {
                    if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;Test  </h2></span>"), o = null;
                    else {
                        var s;
                        if (n[i] ? s = n[i] : Se[i] && (s = function () {
                            ...
                            if (i == "prev") {
                                ...
                                Y(u), o || u.addClass(v + "-corner-right"), o = u
                            }
                        }
                    }
    ...
    function Z(e, n, r) {
        ...
        function g(e) {
            ...
            "variable" == he("weekMode") ? n = r = Math.floor(o / (1 == ee ? 2 : 6)) : (n = Math.floor(o / ee), r = o - n * (ee - 1)), J.each(function (e, o) {
                ee > e && (a = t(o), a.find("> div").css("min-height", "105px"))
            })
        }
