$(document).ready(function () {
    ...
    $(document).delegate(".coverphoto_show", "change", function () {
		...
		var html = "<div class='loading_container' style='background: #eee; padding-top: 53px; padding-bottom: 54px;'><div class='loading_spinner_cover' style='margin-top: 0px'><div class=loading-spinner></div></div>"
		...
		$ref.closest("form").find(".uploadedPhotoFrame").find(".noPhotoText").hide();
		$ref.closest("form").find(".uploadedPhotoFrame").find(".photoicon").hide();
		$ref.closest("form").find(".uploadedPhotoFrame").find(".uploadPhotoBtn").hide();
        ...
        $.ajax({
            ...
            error: function (html) {
				...
				$('link[rel=stylesheet][href~="css/loading.css"]').remove();
				$ref.closest("form").find(".uploadedPhotoFrame").children()[0].remove();
				$ref.closest("form").find(".uploadedPhotoFrame").find(".noPhotoText").show();
				$ref.closest("form").find(".uploadedPhotoFrame").find(".photoicon").show();
				$ref.closest("form").find(".uploadedPhotoFrame").find(".uploadPhotoBtn").show();
				/**** to remove loading animation ****/
